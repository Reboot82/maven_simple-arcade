...
public class ArcadeAccountManager {
    ...
    public ArcadeAccount getAccount(String accountName, String accountPassword) {
        for(ArcadeAccount arcadeAccount : arcadeAccountList) {
            if(arcadeAccount.getAccountName().equals(accountName)) {
                if(arcadeAccount.getAccountPassword().equals(accountPassword)){
    ...
    private List<ArcadeAccount> getArcadeAccountList() {
        return this.arcadeAccountList;
    }
}
